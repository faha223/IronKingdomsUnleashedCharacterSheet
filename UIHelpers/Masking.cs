...
namespace IronKingdomsUnleashedCharacterSheet.UIHelpers
{
    public static class Masking
    {
        ...
        private static void textBox_PreviewKeyDown(object sender, KeyEventArgs e)
        {
            ...
            //explicitly here
            var RelevantKeys = new List<Key>
            {
                Key.Space, Key.Delete, Key.Back
            };

            if(RelevantKeys.Contains(e.Key))
            {

                var proposedText = GetProposedText(textBox, e.Key);
        ...
        private static string GetProposedText(TextBox textBox, Key key)
        {
            var text = textBox.Text;
